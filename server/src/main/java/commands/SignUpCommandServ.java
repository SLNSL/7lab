...
public class SignUpCommandServ implements Command{
    private DataBase dataBase;
    private Messenger messenger;
    private ServerReceiverInterface serverReceiver;

    public SignUpCommandServ(DataBase dataBase, ServerReceiverInterface serverReceiver){
    ...
    public Result<Object> execute(int port, String login,  Object... args) throws IncorrectNumberOfArgumentsException {
        ...
        Result<Object> signInResult = dataBase.signUpUser(login, password, messenger.getString());
